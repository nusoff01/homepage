...
const projects = [
  ...
  {title: 'The demographics of death', content: 'A look at the difference across race, gender, and geography for mortality rates in the United States', tags: ['mortality'], link: 'https://nusoff01.github.io/mortalityFrontend/', imageLink: './images/demographicsOfDeath.png'},
